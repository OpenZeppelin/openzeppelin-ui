...
function packageJson(options: ResolvedCreateOptions, spec: CreateAppSpec): string {
...
function viteConfig(spec: CreateAppSpec): string {
  if (!spec.hasWallet) {
...
function appConfig(options: ResolvedCreateOptions): string {
  return `${JSON.stringify(
    {
...
function ozRuntime(options: ResolvedCreateOptions): string {
...
function rainbowKitConfig(options: ResolvedCreateOptions): string {
