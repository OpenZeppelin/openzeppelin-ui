...
/**
 * Default configuration options for AliasStorage.
 * These values are used when options are not explicitly provided.
 */
export const DEFAULT_OPTIONS: Required<
  Omit<AliasStorageOptions, 'onDuplicate' | 'maxAliasLength'>
> & { maxAliasLength: number | undefined } = {
  duplicateMode: 'strict',
  maxAliasLength: 64,
  tableName: 'aliases',
  enableLogging: typeof process !== 'undefined' ? process.env.NODE_ENV !== 'production' : true,
  logLevel: 'info',
};
