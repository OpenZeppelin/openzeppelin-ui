...
pnpm exec oz-dev tailwind doctor --project /path/to/app
pnpm exec oz-dev tailwind fix --project /path/to/app --dry-run
pnpm exec oz-dev tailwind fix --project /path/to/app
pnpm exec oz-dev tailwind print --project /path/to/app --json
```
...
pnpm exec oz-dev tailwind fix --project "$PWD" --dry-run
