...
- [#219](https://github.com/OpenZeppelin/openzeppelin-ui/pull/219) [`1c63230`](https://github.com/OpenZeppelin/openzeppelin-ui/commit/1c632305bfd4da5b06b8e2db7df1daf151182e84) Thanks [@pasevin](https://github.com/pasevin)! - The generated `.pnpmfile.cjs` now also strips `@metamask/sdk` from `@wagmi/connectors`,
...
- [#217](https://github.com/OpenZeppelin/openzeppelin-ui/pull/217) [`4a363a6`](https://github.com/OpenZeppelin/openzeppelin-ui/commit/4a363a6d05250230d49ec7f5553452aafc0a2856) Thanks [@pasevin](https://github.com/pasevin)! - Add `oz-ui-dev check-peers`, a static guard for stale `@openzeppelin/ui-*` pins.
  ...
  the _minimum_ the range admits, not the range itself. `ui-utils` 4.0.0 against a declared
...
- Updated dependencies [[`c9cb666`](https://github.com/OpenZeppelin/openzeppelin-ui/commit/c9cb666bbdec80408948ee53b5d9fc96c486bb4c)]:
  - @openzeppelin/ui-tailwind-utils@1.0.0
